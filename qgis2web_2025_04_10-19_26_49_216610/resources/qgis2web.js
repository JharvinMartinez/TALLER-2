...
map.getView().fit([-78.776194, -12.721272, -75.155928, -10.317516], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">GEOLOGIA DE LIMA</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (25 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '@Jharvin Martinez Ullilen';
            }
